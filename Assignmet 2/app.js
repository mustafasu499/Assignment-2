...
function populateModels() {
  ...
  modelDropdown.innerHTML = `<option value="">${selectedBrand}</option>`;
  if (selectedBrand) {
...
function showSelected() {
  ...
  <div class="card-body">
    ...
    <h6 class="card-subtitle mb-2 text-body-secondary">${selectedModel}</h6>
    <p class="card-text">${JSON.stringify(selectedMobile)}</p>
...
// `Selected Brand: ${selectedBrand}, Selected Model: ${selectedModel}, Details: ${JSON.stringify(
//       selectedMobile
//     )}`
